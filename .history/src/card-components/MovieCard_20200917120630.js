...
export default class MovieCard extends Component {
  ...
  render() {
    return (
      <div className="movie-card" backgroundImg={`URL(${this.props.posterSrc})`}alt={`${posterMap[this.props.poster]}`}>
        {/* which component should receive which props? */}
        {/* <img url={this.props.posterSrc} alt={`${posterMap[this.props.poster]}`}></img> */}
        <CardFront poster={this.props.poster} posterSrc={this.props.posterSrc}/>
